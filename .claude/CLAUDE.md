...
- **Platform**: Windows
- **Workspace**: C:\Users\jeastaugh\source\repos\Experiments\Sudoku
...
When the user says the plan is ready, write a detailed, human-readable requirements document to `C:\Users\jeastaugh\source\repos\Experiments\Sudoku\.devloop\requirements.md`.
...
After writing requirements.md, convert the plan into a structured task list at `C:\Users\jeastaugh\source\repos\Experiments\Sudoku\.devloop\tasks.md`.
